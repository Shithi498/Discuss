...
//   final String name;
//   final int threadId;
//   const ProfileDetailsScreen({super.key, required this.name, required this.threadId});
//
//   @override
...
//     final bool normalPhone = w >= 360 && w < 420;
...
//     final double cardPadding = smallPhone ? 12 : 16;
...
//                   _sideItem(Icons.info_outline, "Overview", selected: true),
//                   _sideItem(Icons.perm_media_outlined, "Media"),
//                   _sideItem(Icons.insert_drive_file_outlined, "Files"),
//                   _sideItem(Icons.link_outlined, "Links"),
//                   _sideItem(Icons.groups_outlined, "Group members"),
//                   _sideItem(
...
//                   ),
//
//                   // ✅ Dialog-like panel UNDER "Group members"
//                   AnimatedCrossFade(
...
//                           child: SizedBox(
//                             height: 220, // fixed panel height like a dialog
//                             child: Builder(
//                               builder: (_) {
...
//                               children: [
//                                 _sectionTitle("Phone number",subTitleSize as double),
//                                 const SizedBox(height: 6),
//                                 const Text(
//                                   "+880 1313-480404",
...
//   }
//
//   // Widget _sideItem(IconData icon, String title, {bool selected = false}) {
//   //   return Container(
...
//   }
//
//   Widget _sectionTitle(String t, double fontSize) {
//     return Text(
//       t,
//       style: TextStyle(
//         color: Colors.black,
...
//   }
//
//   Widget _rowItem(String title, {required Widget trailing}) {
//     return Row(
//       children: [
//         Expanded(
//           child: Text(
...
final String? image;
  const ProfileDetailsScreen({
    super.key,
    required this.name,
    required this.threadId, this.image,
  });
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              const Text("+880 1313-480404",
                                  style: TextStyle(color: Colors.black, fontSize: 14)),
                              const SizedBox(height: 16),
                              _sectionTitle("Email", subTitleSize),
                              const SizedBox(height: 6),
                              const Text("rumky@gmail.com",
                                  style: TextStyle(color: Colors.black, fontSize: 14)),
                              const SizedBox(height: 16),
                              _sectionTitle("Address", subTitleSize),
                              const SizedBox(height: 6),
